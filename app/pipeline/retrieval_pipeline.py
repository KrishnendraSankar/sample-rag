...
class RetrievalPipeline:
    ...
    def retrieve(
        ...
        # Step 1: Embed the question in dense vector
        dense_question_vector = self.embedding_service.embed_query(question)

        # Step 1: Embed the question in sparse vector
        sparse_question_vector = self.embedding_service.compute_question_sparse_vector(
            question
        )
        ...
        similar_chunks = self.vector_store.search(
            dense_question_vector,
            sparse_question_vector,
            tenant,
            top_k,
